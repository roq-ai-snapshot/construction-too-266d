  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to Construction Tool Rental v1, your one-stop solution for renting construction tools from a centralized supplier with multiple outlets at your convenience."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to Construction Tool Rental v1, your one-stop solution for renting construction tools from a centralized supplier with multiple outlets at your convenience.`}
            </Text>
            <Box
